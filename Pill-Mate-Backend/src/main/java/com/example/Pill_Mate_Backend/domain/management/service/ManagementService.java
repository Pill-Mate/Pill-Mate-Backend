...
public class ManagementService {
    ...
    public ManagementDto.CurrentPillResponseDto getCurrentList(User user) {
            List<Schedule> schedules = scheduleRepository.findByUsersIdAndStatus(userRepository.findIdxByEmail(user.getUsername()).orElseThrow(), ScheduleStatus.ACTIVATE);
    ...
    public List<ManagementDto.CurrentPillResponse> getStopList(User user) {
        List<Schedule> schedules = scheduleRepository.findByUsersIdAndStatus(userRepository.findIdxByEmail(user.getUsername()).orElseThrow(), ScheduleStatus.INACTIVATE);
